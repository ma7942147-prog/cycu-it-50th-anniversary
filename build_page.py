...
<body>
    ...
    <section id="register">
        <div class="travel-card" style="text-align: center;">
            ...
            <div style="display: flex; justify-content: center; gap: 1.5rem; margin-bottom: 2.5rem; flex-wrap: wrap;">
                <a href="https://forms.gle/qSWvXK7SNmE1pZzJ9" target="_blank" class="cta-btn">填寫系慶與餐會線上報名表</a>
                <a href="https://ib.cycu.edu.tw/" target="_blank" class="cta-btn secondary-btn">瀏覽中原國貿系官方網站</a>
            </div>
            ...
            <div class="contact-box-grid">
                ...
                <div class="contact-card">
                    ...
                    <a href="tel:0921899838" class="contact-phone" style="margin-bottom: 0.8rem;">0921-899838</a>
                    <div style="margin-top: 0.5rem;">
                        <a href="https://ib.cycu.edu.tw/" target="_blank" class="contact-phone" style="font-size: 0.85rem; font-weight: 500; background: rgba(255,255,255,0.04); border: 1px solid rgba(212,175,55,0.2);">中原國貿官網 ➔</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Footer -->
    <footer>
        <div class="footer-logo"><a href="https://ib.cycu.edu.tw/" target="_blank" style="color: var(--accent-gold); text-decoration: none;">中原大學國際經營與貿易學系</a></div>
